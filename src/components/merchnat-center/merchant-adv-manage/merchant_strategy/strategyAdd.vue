    ...
    submit(){
      this.$refs.formValidate.validate((valid) => {
        if (valid) {
          ...
          this.apiPost('/merchant/webApi/merchantStrategy/saveMerchantStrategyNewFL', json).then(data=>{
            if(data.success){

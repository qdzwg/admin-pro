<template>
    <div class="inventoryCl">
        <Row>
            ...
            <show-calendar ref="fullCa" class="test-fc" :action="action" :extend="extend" :param="calendarParam" @getCheckInfo="getCheckInfo">
            </show-calendar>
            </Col>
            <Col span="6">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> 
                                <div>
                                  <FormItem label="当天" label-position="left" style="margin-bottom: 5px;">
                                    <!-- <Select v-model="formItem.beforeTime" style="width:80px;">
                                      <Option :value="index" v-for="(item, index) in 24" :key="index">{{index}}</Option>                 
                                    </Select> -->
                                    <TimePicker v-model="formItem.beforeTime" style="width:80px;" format="HH:mm"></TimePicker>
                                    <span style="padding-left:12px;padding-right:12px;">前 价格</span>
                                    <FormItem prop="secondPrice" style="display:inline-block">
                                      <Input style="width:100px" v-model="formItem.secondPrice" placeholder="请填写提前购价格" :maxlength="8"></Input>
                                    </FormItem>
                                  </FormItem>
                                  <FormItem label="成本价" style="margin-top:5px; margin-bottom: 5px;" :label-width="185" label-position="left">
                                    <Input style="width:100px" v-model="formItem.secondCostPrice" placeholder="请填写提前购成本价" :maxlength="8"></Input>
                                  </FormItem>
                                  <FormItem label="库存" style="margin-top:5px; margin-bottom: 5px;" :label-width="185" label-position="left">
                                    <Input style="width:100px" v-model="formItem.secondStock" placeholder="请填写提前购库存" :maxlength="8"></Input>
                                  </FormItem>
                                </div>                           
                                <div>
                                  <FormItem label="当天" label-position="left" style="margin-bottom: 5px;">
                                    ...
                                    <TimePicker v-model="formItem.beforeTime" style="width:80px;" format="HH:mm"></TimePicker>
                                    <span style="padding-left:12px;padding-right:12px;">后 价格</span>
                                    <FormItem prop="refundBeforeDay" style="display:inline-block">
                                      <Input style="width:100px" v-model="formItem.salePrice" placeholder="请填写当天购价格" :maxlength="8"></Input>
                                    </FormItem>
                                  </FormItem>
                                  <FormItem label="成本价" style="margin-top:5px; margin-bottom: 5px;" :label-width="185" label-position="left">
                                    <Input style="width:100px" v-model="formItem.price" placeholder="请填写当天购成本价" :maxlength="8"></Input>
                                  </FormItem>
                                  <FormItem label="库存" style="margin-top:5px; margin-bottom: 5px;" :label-width="185" label-position="left">
                                    <Input style="width:100px" v-model="formItem.totalNum" placeholder="请填写当天购库存" :maxlength="8"></Input>
                                  </FormItem>
                                </div>                  
                            </td>
                        </tr>
...
export default {
  ...
  data() {
    return {
      routeName: "",
      action: "/product/api/showTicketApi/getCalendar",
      extend: [
        {
          title: "提前购成本价",
          key: "secondCostPrice",
  ...
  methods: {
    save() {
      this.formItem.showId = this.$route.params.id;
        ...
        this.$refs.formItem.validate(async valid => {
          ...
          if (valid) {
            let res = await this.apiPost(
              "/product/api/showTicketApi/saveCalendar",
              formData
            );
            if (res.success) {
